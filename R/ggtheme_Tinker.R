...
#' ggtheme_Tinker
#'
#' Custom ggplot2 theme, based on ggplot2::theme()
#'
#' @param ...
#' @param BaseSize Font size that relatively determines all other sizes
#' @param LegendPosition Position of legend ("none", "left", "right", "bottom", "top", or two-element numeric vector)
#' @param SizeFactorPlotTitle
                           ...
                           SizeFactorFacetLabels = 1.33)
{
  ...
  theme_classic() %+replace%
      ...
      theme(#--- Parameters regarding entire plot ------------------------------
            ...
            axis.title = element_text(face = "bold", color = color_DarkGrey, size = rel(SizeFactorAxisLabels)),      # Axis title labels
            ...
            legend.title = element_text(color = color_DarkGrey, size = rel(SizeFactorLegendLabels), face = "bold"),
            legend.text = element_text(color = color_DarkGrey, size = rel(SizeFactorLegendLabels), face = "bold"),
