                           ...
                           SizeFactorFacetLabels = 1.33)
{
    ...
    ggplot2::theme_classic() %+replace%
        ...
        ggplot2::theme(#--- Parameters regarding entire plot ------------------------------
                       ...
                       panel.grid.major.y =  element_line(color = TinkerLab::Colors$MediumGrey),      # Color of y axis major grid lines
                       #--- Axis parameters -----------------------------------------------
                       axis.text = element_text(face = "bold", color = TinkerLab::Colors$DarkGrey),      # Axis tick labels
                       ...
                       axis.title = element_text(face = "bold", color = TinkerLab::Colors$DarkGrey, size = rel(SizeFactorAxisLabels)),      # Axis title labels
                       ...
                       strip.background = element_rect(fill = TinkerLab::Colors$LightGrey, color = "white"),      # No strip background
                       ...
                       legend.title = element_text(color = TinkerLab::Colors$DarkGrey, size = rel(SizeFactorLegendLabels), face = "bold"),
                       legend.text = element_text(color = TinkerLab::Colors$DarkGrey, size = rel(SizeFactorLegendLabels), face = "bold"),
